import { CheckSquare, Flame, Target, CloudSun, TrendingUp, Wallet, BookMarked, GitBranch, Calendar, BarChart3, Share2, Map } from 'lucide-react'
    ...
    <main className="min-h-screen p-4 lg:p-6" style={{ background: '#0f172a' }}>
      <div className="max-w-[1600px] mx-auto space-y-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <Card className="h-[480px]" icon={<Map size={14} />} title="地圖">
            <MapWidget />
          </Card>
        </div>
